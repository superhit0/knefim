...
public class AlgoKNEFIM {
    ...
    /**
     * Run the algorithm
     * @param k  the top-k threshold (a positive integer)
     ...
     */
    public Itemsets runAlgorithm(int k, String inputPath, String outputPath, boolean activateTransactionMerging, int maximumTransactionCount, boolean activateSubtreeUtilityPruning) throws IOException {
